#!/bin/bash
# script pour décompresser une archive. Voir plus loin version plus récente de juin 2024
...
espeak -a 300 -v mb-fr1 -s 130 "le document ob tenu est dans le Dossier-dezip. Le dossier-dezip sera ouvert"
aplay /usr/local/share/advl/beep.wav
aplay /usr/local/share/advl/beep.wav
